...
namespace DevelopmentProj3
{
    public class Reservation
    {
        ...
        public enum WhoIsTryingToCancel
        {
            TheOwner = 1, // The reservation Owner
            NotTheOwnerNotAdmin = 2, // Person who is NOT the owner and NOT the admin
            Admin = 3 // An Admin user
        }
